...
export function startAudio(toggleStartStop, getTranscript, clientCredentials) {
    window.navigator.mediaDevices.getUserMedia({
        video: false,
        audio: true
      })
      .then((medStream) => streamAudioToWebSocket(medStream, toggleStartStop, getTranscript, clientCredentials)) 
...
function streamAudioToWebSocket(userMediaStream, toggleStartStop, getTranscript, clientCredentials) {
    ...
    wireSocketEvents(toggleStartStop, getTranscript);

}


function wireSocketEvents(toggleStartStop, getTranscript) {
    ...
    socket.onmessage = function (message) {
        ...
        if (messageWrapper.headers[":message-type"].value === "event") {
            handleEventStreamMessage(messageBody, getTranscript);
        }
        else {
...
let handleEventStreamMessage = function (messageJson, getTranscript) {
